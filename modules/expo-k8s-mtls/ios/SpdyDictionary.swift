// Auto-generated from moby/spdystream/spdy/dictionary.go.
// SPDY/3 zlib compression dictionary — both endpoints seed their zlib
// state with this exact byte sequence before compressing or decompressing
// the NV (name/value) header blocks in SYN_STREAM / SYN_REPLY / HEADERS
// frames. Defined by the SPDY/3 spec; do not edit.
//
// Length: 1423 bytes.

import Foundation

internal let SPDY3_DICTIONARY: [UInt8] = [
